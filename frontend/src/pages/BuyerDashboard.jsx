    ...
    >
      ...
      <div className="relative w-[390px] h-[844px] rounded-[48px] overflow-hidden shadow-2xl border-[8px] border-zinc-800 bg-[#F7F5F0] flex flex-col">
        ...
        >
          {success && (
            <div
              className="mx-6 mt-2 px-4 py-2.5 rounded-xl text-xs flex items-center justify-between"
                  ...
                  >
                    ...
                    <div className="px-3 py-2.5">
                      ...
                      <div className="flex items-center gap-1 mt-0.5">
                        ...
                        <button
                          onClick={() =>
                            navigate(`/farmer/${product.farmer_id}`)
                          }
                          className="text-[10px] text-[#2D6A4F] font-medium underline"
                        >
                      ...
                      {ordering === product.id ? (
                        <div className="mt-2 space-y-1">
                          ...
                          <button
                            ...
                            style={{
                              background: orderLoading ? "#40916C" : "#2D6A4F",
                            }}
                          >
